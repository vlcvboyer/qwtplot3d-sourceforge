...
int main(int argc, char **argv)
{
    ...
    Curve *curve1 = new Curve(plot1);
    plot1->addCurve(curve1);
    Saddle *saddle = new Saddle(*curve1);
    saddle->create();
    ...
    Curve *curve2 = new Curve(plot2);
    plot2->addCurve(curve2);
    Hat *hat = new Hat(*curve2);
    hat->create();
